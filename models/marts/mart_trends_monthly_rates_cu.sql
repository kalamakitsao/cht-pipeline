...
num_chp AS (
  SELECT 'monthly_rates_active_chp'::text AS metric_id, a.level, a.county_id, a.county, a.sub_county_id, a.sub_county, a.community_unit_id, a.community_unit, a.period_start, a.month_year, SUM(a.value) AS numerator_value
  FROM chp_activity a
