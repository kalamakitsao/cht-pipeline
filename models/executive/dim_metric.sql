...
FROM (
    VALUES
        ...
        ('u5_malnutrition_male', 'U5 Disease Burden – Male Malnutrition', 'Child Health (<5 years)', 'Confirmed cases of malnutrition in children under 5', 'count'),
        ('u5_malnutrition_female', 'U5 Disease Burden – Female Malnutrition', 'Child Health (<5 years)', 'Confirmed cases of malnutrition in children under 5', 'count'),
        ('u5_tested_malaria', 'U5 Tested Malaria', 'Child Health (<5 years)', 'Confirmed cases of malaria in children under 5', 'count'),
        ...
        ('treated_for_malaria', 'Treated for Malaria', 'Child Health (<5 years)', 'Children Treated for Malaria', 'count'),
        ('treated_for_pneumonia', 'Treated for Pneumonia', 'Child Health (<5 years)', 'Children Treated for Suspected Pneumonia', 'count'),
        ('treated_for_diarrhoes', 'Treated for Dirrhoea', 'Child Health (<5 years)', 'Children Treated for Suspected Diarrhoea', 'count'),
        ...
        ('referred_for_diarrhoes', 'Referred for Dirrhoea', 'Child Health (<5 years)', 'Children Referred for Suspected Diarrhoea', 'count'),
