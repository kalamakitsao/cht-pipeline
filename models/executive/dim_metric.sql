...
FROM (
    VALUES
        ...
        ('u5_pneumonia_cases', 'U5 Disease Burden – Pneumonia', 'Child Health (<5 years)', 'Suspected cases of pneumonia in children under 5', 'count'),
        ('u5_malnutrition_cases', 'U5 Disease Burden – Malnutrition', 'Child Health (<5 years)', 'Suspected cases of malnutrition in children under 5', 'count'),
        ('u5_malnutrition_male', 'U5 Disease Burden – Male Malnutrition', 'Child Health (<5 years)', 'Suspected cases of malnutrition in male children under 5', 'count'),
        ('u5_malnutrition_female', 'U5 Disease Burden – Female Malnutrition', 'Child Health (<5 years)', 'Suspected cases of malnutrition in female children under 5', 'count'),
        ('u5_tested_malaria', 'U5 Tested Malaria', 'Child Health (<5 years)', 'Number of malaria tests performed on children under 5.', 'count'),
        ('u5_confirmed_malaria_cases', 'U5 Disease Burden – Confirmed Malaria', 'Child Health (<5 years)', 'Confirmed cases of malaria in children under 5', 'count'), 
        ('u5_suspected_malaria_cases', 'U5 Disease Burden – Suspected Malaria', 'Child Health (<5 years)', 'Suspected cases of malaria in children under 5', 'count'), 
        ('u5_treated_malaria', 'Treated for Malaria', 'Child Health (<5 years)', 'Children Treated for Malaria', 'count'),
        ('u5_treated_pneumonia', 'Treated for Pneumonia', 'Child Health (<5 years)', 'Children Treated for Suspected Pneumonia', 'count'),
        ('u5_treated_diarrhoea', 'Treated for Diarrhoea', 'Child Health (<5 years)', 'Children Treated for Suspected Diarrhoea', 'count'),
        ('referred_for_malaria', 'Referred for Malaria', 'Child Health (<5 years)', 'Children Referred for Suspected Malaria', 'count'),
        ('under_1_immunised_male', 'Male Under 1 Year Fully Immunised', 'Child Health (<5 years)', 'Number of male children under 1 year who are fully immunised', 'count'),
        ...
        ('referred_for_development_milestones', 'Referred for Development Milestones', 'Child Health (<5 years)', 'Children Referred for Further Assessment Based on Developmental Milestone Screening', 'count'),
        ('male_referred_for_development_milestones', 'Male Referred for Development Milestones', 'Child Health (<5 years)', 'Male Children Referred for Further Assessment Based on Developmental Milestone Screening', 'count'),
        ('female_referred_for_development_milestones', 'Female Referred for Development Milestones', 'Child Health (<5 years)', 'Female Children Referred for Further Assessment Based on Developmental Milestone Screening', 'count'),
        ...
        ('screened_diabetes_male', 'Male Screened for Diabetes', 'NCDs (Chronic Illnesses)', 'Number of male screened for diabetes', 'count'),
        ('screened_diabetes_female', 'Female Screened for Diabetes', 'NCDs (Chronic Illnesses)', 'Number of female screened for diabetes', 'count'),
        ...
        ('screened_mental_health', 'Screened for Mental Health', 'NCDs (Chronic Illnesses)', 'Number of people screened for Mental Health', 'count'),
        ...
        ('referred_mental_health', 'Referred for Mental Health', 'NCDs (Chronic Illnesses)', 'Number of people referred for Mental Health care', 'count'),
        ...
        ('over_5_referred', 'Over 5 Referrals', 'NCDs (Chronic Illnesses)', 'Over 5s assessed and referred', 'count'),
