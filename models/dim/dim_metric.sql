...
FROM (
    VALUES
        ...
        ('u5_assessed_malaria_female', 'Total U5 Female Population assessments for malaria', 'Child Health (<5 years)', 'Assessments on female Children under 5 for danger signs related to malaria during the period','count',  'child_health'),
